    ...
    return (
      <div>
        { this.state.isLoading ? <Spinner /> :
          <div className="ml-auto mr-auto mt-20 w-full max-w-sm px-4 py-6 space-y-6 bg-white rounded-md dark:bg-darker">
            ...
            <form action="#" className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center">
                  ...
                  <span className="ml-3 text-sm font-normal text-gray-500 dark:text-gray-400">Remember me</span>
                </label>
              ...
              <div>
                <button onClick={this.handleLogin}
                  className="w-full px-4 py-2 font-medium text-center bg-green-500 text-white transition-colors duration-200 rounded-md bg-primary hover:bg-primary-dark focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-1"
                >
                  Login
                </button>
              </div>
            ...
            <div className="text-sm text-gray-600 dark:text-gray-400">
              Don't have an account yet? <a href="register.html" className="text-blue-600 hover:underline">Register</a>
            </div>
          </div>
        }
      </div>
