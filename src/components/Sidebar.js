    ...
    return (
      <div className="top-16 fixed avail-height w-1/5 bg-white border-r-2 border-gray-200 ">
        <div className="text-gray-500">
          <div className="mt-10">
            <div>
              <Link className="mx-6 flex flex-row items-center bg-red-100 h-12 rounded-md hover:shadow-lg hover:text-gray-800" to="/dashboard">
            ...
            <div>
              <Link className="mx-6 flex flex-row items-center h-12 rounded-md hover:shadow-lg hover:text-gray-800" to="/live-test">
            ...
            <div>
              <Link className="mx-6 flex flex-row items-center h-12 rounded-md hover:shadow-lg hover:text-gray-800" to="past-test">
            ...
            <div>
              <Link className="mx-6 flex flex-row items-center h-12 rounded-md hover:shadow-lg hover:text-gray-800" to="/attempted">
          ...
          <div className="absolute bottom-0 left-0 w-full border-t-2">
            <div className="flex flex-row items-center mx-6 my-3">
              ...
              <div className="flex flex-col text-sm ml-5">
                ...
                <Link to="/profile" className="text-gray-500 hover:text-green-600">
                  View Profile
                </Link>
              </div>
            </div>
